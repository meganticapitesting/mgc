...
namespace Megantic\Mgc\Model;

use Magento\Catalog\Model\ProductFactory;
use Megantic\Mgc\Api\Data\ItemInterface;
...
class Item extends AbstractModel implements ItemInterface, IdentityInterface
{
    ...
    {
        $this->_init('Megantic\Mgc\Model\ResourceModel\Item');
    }
    ...
    {
        return $this->_urlBuilder->getUrl('Mgc/' . $this->getUrlKey());
    }
