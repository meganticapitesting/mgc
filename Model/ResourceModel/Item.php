...
namespace Megantic\Mgc\Model\ResourceModel;
...
class Item extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
     ...
     * @param string $field
     * @param mixed $value
     * @param \Megantic\Mgc\Model\Item $object
    ...
    public function checkUrlKey($url_key)
    {
        ...
        $select->reset(\Zend_Db_Select::COLUMNS)->columns('tbl.id')->limit(1);
